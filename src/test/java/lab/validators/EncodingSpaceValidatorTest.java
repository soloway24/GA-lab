...
class EncodingSpaceValidatorTest {
    ...
    public void whenValidFunctionThenSuccess() {
        ...
        EncodingSpaceValidator.validateEncodingSpace(CHROMOSOME_LENGTH, MIN_X, maxX, DOUBLE_ARGUMENT_PRECISION);
    }
    ...
    public void whenValidFunctionWithIntegerArgumentsThenSuccess() {
        ...
        EncodingSpaceValidator.validateEncodingSpace(CHROMOSOME_LENGTH, MIN_X, maxX, INTEGER_ARGUMENT_PRECISION);
    }
