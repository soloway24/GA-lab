...
public enum FitnessFunction {
    ...
    private final Individual bestBinary;
    private final Individual bestGray;
    private final boolean applyOperators;

    FitnessFunction(int L, char optimal, String out, double min, double max, double minX, double maxX, Individual bestBinary, Individual bestGray, boolean applyOperators) {
        this.L = L;
    ...
    public Individual getBest() {
        if (bestGray == null)
            return bestBinary;
        return GeneticUtils.ENCODING == Encoding.BINARY ? bestBinary : bestGray;
    }
}
