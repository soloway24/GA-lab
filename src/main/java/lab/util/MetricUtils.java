...
public class MetricUtils {
    ...
    public static double getDifference(Map<Individual, ? extends Number> individualToFitness,
        ...
        double currentFAvg = CalculationUtils.getAverage(individualToFitness.values());
        double parentPoolFAvg = CalculationUtils.getAverage(parentPoolToFitness.values());
    ...
    public static double computePFET(List<Double> fitnesses, List<Long> offspringCounts) {
        ...
        double medianOffspringCount = CalculationUtils.getMedian(offspringCounts);
