...
public class F1_2Function implements FitnessFunction<Double, Double> {

    private static final String OPTIMAL_STANDARD_CODE = "1111111111";
    private static final String OPTIMAL_GRAY_CODE = "1000000000";
    ...
    public F1_2Function(int arity, int chromosomeLength, double minX, double maxX, int argumentPrecision) {
