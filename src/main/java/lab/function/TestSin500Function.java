...
public class TestSin500Function implements FitnessFunction<Double, Double> {
    ...
    private static final double EXPONENT = 500;
    ...
    public TestSin500Function(int chromosomeLength, double minX, double maxX, int argumentPrecision) {
